...
_reactDom2.default.render(_react2.default.createElement(Message, { title: 'Email Lee test', message: 'Can you email him?' }), document.getElementById('react-container'));
  ...
  (function () {
    ...
    var ReactFiberClassComponent = function ReactFiberClassComponent(scheduleWork, computeExpirationForFiber, memoizeProps, memoizeState) {
      ...
      function checkClassInstance(workInProgress) {
        ...
        if (typeof instance.getChildContext === 'function') {
          !(_typeof(workInProgress.type.childContextTypes) === 'object') ? invariant(false, '%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().', getComponentName(workInProgress)) : void 0;
        }
      }
    ...
    function ChildReconciler(shouldClone, shouldTrackSideEffects) {
      ...
      function reconcileChildFibers(returnFiber, currentFirstChild, newChild, expirationTime) {
        ...
        if (enableReactFragment && (typeof newChild === 'undefined' ? 'undefined' : _typeof(newChild)) === 'object' && newChild !== null && newChild.type === REACT_FRAGMENT_TYPE && newChild.key === null) {
...

    {
      ...
      var validateProperty$1 = function validateProperty$1(tagName, name, value) {
    ...
    var warnUnknownProperties = function warnUnknownProperties(type, props) {
      var unknownProps = [];
      for (var key in props) {
